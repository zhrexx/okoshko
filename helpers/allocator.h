...
static void oko_temp_reset_to_marker(oko_temp_allocator* alloc,
...
static inline void* oko_temp_alloc_default(oko_temp_allocator* alloc,
                                           u64 size) {
...
#define oko_temp_scope(alloc)                                                  \
  for (oko_temp_marker _oko_marker = oko_temp_get_marker(alloc),               \
                       _oko_done = {0};                                        \
       !_oko_done.offset;                                                      \
